...
class gosofie_service extends Widget_Base {

    public function get_name() {
        return 'gosofie-service';
    }

    public function get_title() {
        return __('Service', 'gosoFie');
    }
...
$widgets_manager->register_widget_type(new \GosofieAddon\Widgets\gosofie_service());