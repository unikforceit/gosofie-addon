...
function magnews_orderby_post(){
    return array(
        'none' => __('No order', 'gosofie'),
        'ID' => __('Post ID', 'gosofie'),
        'author' => __('Author', 'gosofie'),
        'title' => __('Title', 'gosofie'),
        'date' => __('Published date', 'gosofie'),
        'modified' => __('Modified date', 'gosofie'),
        'parent' => __('By parent', 'gosofie'),
        'rand' => __('Random order', 'gosofie'),
        'comment_count' => __('Comment count', 'gosofie'),
        'menu_order' => __('Menu order', 'gosofie'),
        'post__in' => __('By include order', 'gosofie'),
    );  
}
...
function madmag_ft_images($thumbnail){
    ...
    $placeholder =  AE_PLUGIN_URL . 'assets/lazyload.svg';
